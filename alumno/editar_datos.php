            ...
            <div class="col-md-8">
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5 font-weight-bold mt-4 text-center">DATOS PERSONALES</p>
                            <div class="form-row mb-2">
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">CURP:<span class="text-danger">*</span></label>
                                    <input type="text" name="curp" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" placeholder="Ingrese curp" value="<?php echo $curp ?>">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nombre" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $nombre ?>" placeholder="Ingrese su nombre">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Apellido paterno: <span class="text-danger">*</span></label>
                                    <input type="text" name="apellido_p" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $apellido_p ?>" placeholder="Ingrese apellido paterno">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Apellido materno: <span class="text-danger">*</span></label>
                                    <input type="text" name="apellido_m" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $apellido_m ?>" placeholder="Ingrese apellido materno">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Fecha de nacimiento: <span class="text-danger">*</span></label>
                                    <input type="date" name="fecha_nac" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $fecha_nac ?>" placeholder="Ingrese su fecha de nacimiento">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Edad: <span class="text-danger">*</span></label>
                                    <input type="text" name="edad" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $edad ?>" placeholder="Ingrese su edad">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="medio" class="custom-select" id="medio" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $medio ?>">
                                        <option selected="true" disabled="disabled">Seleccione</option>
                                        <option value="Redes Sociales"
                                        <?php if ($medio=='Redes Sociales') { ?> selected <?php } ?>>Redes Sociales</option>
                                        <option value="Promotor"
                                        <?php if ($medio=='Promotor') { ?> selected <?php } ?>>Promotor</option>
                                        <option value="Otro"
                                        <?php if ($medio=='Otro') { ?> selected <?php } ?>>Otro</option>
                                    </select>
                                </div>
                            </div>

                            <!--Datos de localización-->
                            <p class="mb-5 font-weight-bold text-center">DATOS DE LOCALIZACIÓN</p>
                            <div class="form-row mb-2">
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Teléfono: <span class="text-danger">*</span></label>
                                    <input type="text" name="telefono" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $telefono ?>" placeholder="Ingrese su número de teléfono">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Calle: <span class="text-danger">*</span></label>
                                    <input type="text" name="calle" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $calle ?>" placeholder="Ingrese su calle">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Colonia: <span class="text-danger">*</span></label>
                                    <input type="text" name="colonia" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $colonia ?>" placeholder="Ingrese su colonia">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Municipio: <span class="text-danger">*</span></label>
                                    <input type="text" name="municipio" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $municipio ?>" placeholder="Ingrese su municipio">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">CP:<span class="text-danger">*</span></label>
                                    <input type="text" name="cp" class="form-control" id="ing" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $cp ?>" placeholder="Ingrese su código postal">
                                </div>
                            </div>
                            <!--Datos de salud-->
                            <p class="mb-4 font-weight-bold mt-4 text-center">ESTADO DE SALUD</p>
                            ...
                            <div class="form-row mb-2">
                                <div class="form-group mb-3 col-md-8">
                                    ...
                                    >Si
                                    <input type="radio" name="seguro_med" value="false"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="servicio" class="custom-select" id="servicio" style="border: black 1px solid; box-shadow: 0px 10px 10px black;">
                                        <option selected="true" disabled="disabled">Seleccione</option>
                                        <option value="IMSS"
                                    <?php if ($servicio=='IMSS') { ?> selected <?php } ?>>IMSS</option>
                                        <option value="ISSTE"
                                    <?php if ($servicio=='ISSTE') { ?> selected <?php } ?>>ISSTE</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="num_seguridad" id="num_seguridad" class="form-control" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $num_seguridad ?>" placeholder="Ingresa tu número de seguridad social">
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <?php if ($estado=='REGULAR') { ?> checked <?php } ?>>Regular
                                ...
                                <div class="form-group col-md-10">
                                    ...
                                    <input type="radio" name="prescripcion" value="NO"
                                    <?php if ($prescripcion=='NO') { ?> checked <?php } ?>>No
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Observaciones generales:</label>
                                    <input type="text" name="observaciones" id="observaciones" class="form-control" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $observaciones ?>" placeholder="Ingresa observaciones en caso de tenerlas">
                                </div>
                            </div>

                            <!--Datos de logeo-->
                            <p class="mb-5 font-weight-bold mt-4 text-center">DATOS DEL LOGEO</p>
                            <div class="form-row mb-2">
                                <div class="form-group col-md-6">
                                    <label class="font-weight-bold">Correo electrónico <span class="text-danger">*</span></label>
                                    <input type="email" name="email" id="email" class="form-control" style="border: black 1px solid; box-shadow: 0px 10px 10px black;" value="<?php echo $email ?>" placeholder="Ingresa tu correo electrónico">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <button type="submit" name="accion" value="enviar" id="btn" class="btn font-weight-bold btn-success" style="width:90px">Guardar</button>
